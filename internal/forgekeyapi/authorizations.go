...
func (c *Client) RevokeAuthorization(ctx context.Context, id int) error {
	return c.Post(ctx, fmt.Sprintf("/api/forgekey/authorizations/%d/revoke", id), nil, nil)
}
...
func (c *Client) Unlock(ctx context.Context, id int) error {
	return c.Post(ctx, fmt.Sprintf("/api/forgekey/lockouts/%d/unlock", id), nil, nil)
}
...
type OperationalMode struct {
	...
	ClassroomModeEnabledBy  *int       `json:"classroom_mode_enabled_by,omitempty"`
...
func (c *Client) EnableClassroomMode(ctx context.Context, id int) error {
	return c.Post(ctx, fmt.Sprintf("/api/forgekey/operational-modes/%d/enable_classroom_mode", id), nil, nil)
}

func (c *Client) DisableClassroomMode(ctx context.Context, id int) error {
	return c.Post(ctx, fmt.Sprintf("/api/forgekey/operational-modes/%d/disable_classroom_mode", id), nil, nil)
}
...
func (c *Client) EndSession(ctx context.Context, id int) error {
	return c.Post(ctx, fmt.Sprintf("/api/forgekey/usage/%d/end_session", id), nil, nil)
}
