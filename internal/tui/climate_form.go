...
func (s *ThermostatFormScreen) formBarItems(paging bool) []actionBarItem {
...
func (s *ThermostatFormScreen) pickBar(header jdeHeader, body *jdeLines) []actionBarItem {
...
func (s *ThermostatListScreen) paneCells() int { return proseBarCells(s.terminalWidth) }
...
// It used to be
//
//	j/k move · enter/E edit · c new · x delete · r refresh · esc back
//
...
func (s *ThermostatListScreen) bar(moves bool) proseBar {
	return append(proseNavCursor(moves),
		proseBarItem{Keys: []string{"enter", "E"}, Hint: "enter/E edit"},
