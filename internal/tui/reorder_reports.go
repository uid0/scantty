	...
	return NewReportTableScreen(deps, "Reorders analytics", []reportTab{
		{
			...
			columns: []reportColumn{
				...
				{"Avg lead d", alignRight}, {"On-time %", alignRight}, {"Late %", alignRight},
				{"Damage %", alignRight}, {"Order value", alignRight},
			},
			note: "Rates are percentages · Order value = Σ estimated PO total · sorted by value desc.",
		...
		},
		{
			...
			columns: []reportColumn{
				{"Month", alignLeft}, {"Avg lead d", alignRight}, {"Avg var d", alignRight},
				{"Deliveries", alignRight}, {"On-time %", alignRight},
			},
			note: "Lead / variance in days · trailing 6 months · rate is a percentage.",
			loader: func(ctx context.Context, deps Deps) ([][]string, error) {
